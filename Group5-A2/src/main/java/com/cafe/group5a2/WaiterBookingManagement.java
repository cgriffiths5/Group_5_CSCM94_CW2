...
public class WaiterBookingManagement {
    ...
    public CheckBox reject1; public CheckBox reject2;
    public CheckBox reject3; public CheckBox reject4;
    public CheckBox reject5; public CheckBox reject6;
    public CheckBox reject7; public CheckBox reject8;
    public CheckBox reject9; public CheckBox reject10;
    public CheckBox reject11; public CheckBox reject12;
    public CheckBox reject13; public CheckBox reject14;
    public CheckBox reject15; public CheckBox reject16;
    public CheckBox reject17; public CheckBox reject18;
    public CheckBox reject19; public CheckBox reject20;
    public CheckBox reject21; public CheckBox reject22;

    public CheckBox approve1; public CheckBox approve2;
    public CheckBox approve3; public CheckBox approve4;
    public CheckBox approve5; public CheckBox approve6;
    public CheckBox approve7; public CheckBox approve8;
    public CheckBox approve9; public CheckBox approve10;
    public CheckBox approve11; public CheckBox approve12;
    public CheckBox approve13; public CheckBox approve14;
    public CheckBox approve15; public CheckBox approve16;
    public CheckBox approve17; public CheckBox approve18;
    public CheckBox approve19; public CheckBox approve20;
    public CheckBox approve21; public CheckBox approve22;
    ...
    public Label data1; public Label data2;
    public Label data3; public Label data4;
    public Label data5; public Label data6;
    public Label data7; public Label data8;
    public Label data9; public Label data10;
    public Label data11; public Label data12;
    public Label data13; public Label data14;
    public Label data15; public Label data16;
    public Label data17; public Label data18;
    public Label data19; public Label data20;
    public Label data21; public Label data22;

    public Label tables1; public Label tables2;
    public Label tables3; public Label tables4;
    public Label tables5; public Label tables6;
    public Label tables7; public Label tables8;
    public Label tables9; public Label tables10;
    public Label tables11; public Label tables12;
    public Label tables13; public Label tables14;
    public Label tables15; public Label tables16;
    public Label tables17; public Label tables18;
    public Label tables19; public Label tables20;
    public Label tables21; public Label tables22;
    ...
    public void hideEmpty() {
        ...
        if (name5 .getText().equals("Name")) { name5 .setOpacity(0.0); data5 .setOpacity(0.0); tables5 .setOpacity(0.0); approve5 .setOpacity(0.0); reject5 .setOpacity(0.0); }
        if (name6 .getText().equals("Name")) { name6 .setOpacity(0.0); data6 .setOpacity(0.0); tables6 .setOpacity(0.0); approve6 .setOpacity(0.0); reject6 .setOpacity(0.0); }
        if (name7 .getText().equals("Name")) { name7 .setOpacity(0.0); data7 .setOpacity(0.0); tables7 .setOpacity(0.0); approve7 .setOpacity(0.0); reject7 .setOpacity(0.0); }
        if (name8 .getText().equals("Name")) { name8 .setOpacity(0.0); data8 .setOpacity(0.0); tables8 .setOpacity(0.0); approve8 .setOpacity(0.0); reject8 .setOpacity(0.0); }
        if (name9 .getText().equals("Name")) { name9 .setOpacity(0.0); data9 .setOpacity(0.0); tables9 .setOpacity(0.0); approve9 .setOpacity(0.0); reject9 .setOpacity(0.0); }
        if (name10.getText().equals("Name")) { name10.setOpacity(0.0); data10.setOpacity(0.0); tables10.setOpacity(0.0); approve10.setOpacity(0.0); reject10.setOpacity(0.0); }
        if (name11.getText().equals("Name")) { name11.setOpacity(0.0); data11.setOpacity(0.0); tables11.setOpacity(0.0); approve11.setOpacity(0.0); reject11.setOpacity(0.0); }
        if (name12.getText().equals("Name")) { name12.setOpacity(0.0); data12.setOpacity(0.0); tables12.setOpacity(0.0); approve12.setOpacity(0.0); reject12.setOpacity(0.0); }
        if (name13.getText().equals("Name")) { name13.setOpacity(0.0); data13.setOpacity(0.0); tables13.setOpacity(0.0); approve13.setOpacity(0.0); reject13.setOpacity(0.0); }
        if (name14.getText().equals("Name")) { name14.setOpacity(0.0); data14.setOpacity(0.0); tables14.setOpacity(0.0); approve14.setOpacity(0.0); reject14.setOpacity(0.0); }
        if (name15.getText().equals("Name")) { name15.setOpacity(0.0); data15.setOpacity(0.0); tables15.setOpacity(0.0); approve15.setOpacity(0.0); reject15.setOpacity(0.0); }
        if (name16.getText().equals("Name")) { name16.setOpacity(0.0); data16.setOpacity(0.0); tables16.setOpacity(0.0); approve16.setOpacity(0.0); reject16.setOpacity(0.0); }
        if (name17.getText().equals("Name")) { name17.setOpacity(0.0); data17.setOpacity(0.0); tables17.setOpacity(0.0); approve17.setOpacity(0.0); reject17.setOpacity(0.0); }
        if (name18.getText().equals("Name")) { name18.setOpacity(0.0); data18.setOpacity(0.0); tables18.setOpacity(0.0); approve18.setOpacity(0.0); reject18.setOpacity(0.0); }
        if (name19.getText().equals("Name")) { name19.setOpacity(0.0); data19.setOpacity(0.0); tables19.setOpacity(0.0); approve19.setOpacity(0.0); reject19.setOpacity(0.0); }
            ...
            while(rs.next()) {
                ...
                if (u1 == 0 && d1.equals("0000-00-00") && h1 == 0 && i == 1) {
                    ...
                    if (d.compareTo(d1 ) == 0 && h == h1 && u == u1)
                        tables1.setText(tables1.getText() + ", " + t); else i++;
                ...
                if (u2 == 0 && d2.equals("0000-00-00") && h2 == 0 && i == 2) {
                    ...
                    if (d.compareTo(d2 ) == 0 && h == h2 && u == u2)
                        tables2.setText(tables2.getText() + ", " + t); else i++;
                }
                if (u3 == 0 && d3.equals("0000-00-00") && h3 == 0 && i == 3) {
                    ...
                    if (d.compareTo(d3 ) == 0 && h == h3 && u == u3)
                        tables3.setText(tables3.getText() + ", " + t); else i++;
                }
                if (u4 == 0 && d4.equals("0000-00-00") && h4 == 0 && i == 4) {
                    ...
                    if (d.compareTo(d4 ) == 0 && h == h4 && u == u4)
                        tables4.setText(tables4.getText() + ", " + t); else i++;
                }
                if (u5 == 0 && d5.equals("0000-00-00") && h5 == 0 && i == 5) {
                    ...
                    if (d.compareTo(d5 ) == 0 && h == h5 && u == u5)
                        tables5.setText(tables5.getText() + ", " + t); else i++;
                }
                if (u6 == 0 && d6.equals("0000-00-00") && h6 == 0 && i == 6) {
                    ...
                    if (d.compareTo(d6 ) == 0 && h == h6 && u == u6)
                        tables6.setText(tables6.getText() + ", " + t); else i++;
                }
                if (u7 == 0 && d7.equals("0000-00-00") && h7 == 0 && i == 7) {
                    ...
                    if (d.compareTo(d7 ) == 0 && h == h7 && u == u7)
                        tables7.setText(tables7.getText() + ", " + t); else i++;
                }
                if (u8 == 0 && d8.equals("0000-00-00") && h8 == 0 && i == 8) {
                    ...
                    if (d.compareTo(d8 ) == 0 && h == h8 && u == u8)
                        tables8.setText(tables8.getText() + ", " + t); else i++;
                }
                if (u9 == 0 && d9.equals("0000-00-00") && h9 == 0 && i == 9) {
                    ...
                    if (d.compareTo(d9 ) == 0 && h == h9 && u == u9)
                        tables9.setText(tables9.getText() + ", " + t); else i++;
                }
                if (u10 == 0 && d10.equals("0000-00-00")  && h10 == 0 && i == 10) {
                    ...
                    if (d.compareTo(d10) == 0 && h == h10 && u == u10)
                        tables10.setText(tables10.getText() + ", " + t); else i++;
                }
                if (u11 == 0 && d11.equals("0000-00-00")  && h11 == 0 && i == 11) {
                    ...
                    if (d.compareTo(d11) == 0 && h == h11 && u == u11)
                        tables11.setText(tables11.getText() + ", " + t); else i++;
                }
                if (u12 == 0 && d12.equals("0000-00-00")  && h12 == 0 && i == 12) {
                    ...
                    if (d.compareTo(d12) == 0 && h == h12 && u == u12)
                        tables12.setText(tables12.getText() + ", " + t); else i++;
                }
                if (u13 == 0 && d13.equals("0000-00-00")  && h13 == 0 && i == 13) {
                    ...
                    if (d.compareTo(d13) == 0 && h == h13 && u == u13)
                        tables13.setText(tables13.getText() + ", " + t); else i++;
                }
                if (u14 == 0 && d14.equals("0000-00-00")  && h14 == 0 && i == 14) {
                    ...
                    if (d.compareTo(d14) == 0 && h == h14 && u == u14)
                        tables14.setText(tables14.getText() + ", " + t); else i++;
                }
                if (u15 == 0 && d15.equals("0000-00-00")  && h15 == 0 && i == 15) {
                    ...
                    if (d.compareTo(d15) == 0 && h == h15 && u == u15)
                        tables15.setText(tables15.getText() + ", " + t); else i++;
                    ...
                    if (d.compareTo(d16) == 0 && h == h16 && u == u16)
                        tables16.setText(tables16.getText() + ", " + t); else i++;
                }
                if (u17 == 0 && d17.equals("0000-00-00")  && h17 == 0 && i == 17) {
                    ...
                    if (d.compareTo(d17) == 0 && h == h17 && u == u17)
                        tables17.setText(tables17.getText() + ", " + t); else i++;
                }
                if (u18 == 0 && d18.equals("0000-00-00")  && h18 == 0 && i == 18) {
                    ...
                    if (d.compareTo(d18) == 0 && h == h18 && u == u18)
                        tables18.setText(tables18.getText() + ", " + t); else i++;
                }
                if (u19 == 0 && d19.equals("0000-00-00")  && h19 == 0 && i == 19) {
                    ...
                    if (d.compareTo(d19) == 0 && h == h19 && u == u19)
                        tables19.setText(tables19.getText() + ", " + t); else i++;
                }
                if (u20 == 0 && d20.equals("0000-00-00")  && h20 == 0 && i == 20) {
                    ...
                    if (d.compareTo(d20) == 0 && h == h20 && u == u20)
                        tables20.setText(tables20.getText() + ", " + t); else i++;
                }
                if (u21 == 0 && d21.equals("0000-00-00")  && h21 == 0 && i == 21) {
                    ...
                    if (d.compareTo(d21) == 0 && h == h21 && u == u21)
                        tables21.setText(tables21.getText() + ", " + t); else i++;
                }
                if (u22 == 0 && d22.equals("0000-00-00")  && h22 == 0 && i == 22) {
                    ...
                    if (d.compareTo(d22) == 0 && h == h22 && u == u22)
                        tables22.setText(tables22.getText() + ", " + t); else i++;
                }
     ...
     */
    public void remove(){
        updateCapacityTableAvailabilityTo1(capID1 );  deleteBooking(capID1 );
        updateCapacityTableAvailabilityTo1(capID2 );  deleteBooking(capID2 );
        updateCapacityTableAvailabilityTo1(capID3 );  deleteBooking(capID3 );
        updateCapacityTableAvailabilityTo1(capID4 );  deleteBooking(capID4 );
        updateCapacityTableAvailabilityTo1(capID5 );  deleteBooking(capID5 );
        updateCapacityTableAvailabilityTo1(capID6 );  deleteBooking(capID6 );
        updateCapacityTableAvailabilityTo1(capID7 );  deleteBooking(capID7 );
        updateCapacityTableAvailabilityTo1(capID8 );  deleteBooking(capID8 );
        updateCapacityTableAvailabilityTo1(capID9 );  deleteBooking(capID9 );
        updateCapacityTableAvailabilityTo1(capID10);  deleteBooking(capID10);
        updateCapacityTableAvailabilityTo1(capID11);  deleteBooking(capID11);
    }
