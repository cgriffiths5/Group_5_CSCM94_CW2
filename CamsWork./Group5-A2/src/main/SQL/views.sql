...
SELECT table_number FROM list_orders WHERE type = 'seated' AND prepared = 1 AND complete = 0 ORDER BY date_time ASC LIMIT 4;
SELECT f_name, l_name FROM list_orders WHERE type = 'takeaway' AND prepared = 1 AND complete = 0 ORDER BY date_time ASC LIMIT 4;
